...
out.extend(
    [
        ...
        '<script src="../assets/javascript/inc-subdomains-filter.js?v=21"></script>',
        ...
        '<script src="../assets/javascript/inc-host-scan.js?v=56"></script>',
        "</body>",
        "</html>",
    ]
)
...
PY
    ...
    f_omit_missing_page_nav "$report_dir" "$page"
}
